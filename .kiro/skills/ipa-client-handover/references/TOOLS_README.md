...
- `output_dir`: Output directory for JSON files (optional, defaults to 'Temp')

**Examples:**
```bash
# Without WU log
python ReusableTools/IPA_ClientHandover/preprocess_client_handover.py process.lpd spec.docx

# With WU log
python ReusableTools/IPA_ClientHandover/preprocess_client_handover.py process.lpd spec.docx wu_log.txt

# With WU log and custom output directory
python ReusableTools/IPA_ClientHandover/preprocess_client_handover.py process.lpd spec.docx wu_log.txt Output
```
